...
public class PacketOpcodes {
    ...
    public static final int PerformOperationNotify = 1182;
    ...
    public static final int ChannelerSlabStageOneoffDungeonNotify = 8475;
    public static final int ChannellerSlabWearBuffReq = 8479;
    public static final int ChannellerSlabWearBuffRsp = 8925;
    public static final int ChannellerSlabTakeoffBuffReq = 8133;
    public static final int ChannellerSlabTakeoffBuffRsp = 8631;
    public static final int ChannellerSlabEnterLoopDungeonReq = 8088;
    public static final int ChannellerSlabEnterLoopDungeonRsp = 8121;
    public static final int ChannellerSlabLoopDungeonTakeFirstPassRewardReq = 8381;
    public static final int ChannellerSlabLoopDungeonTakeFirstPassRewardRsp = 8068;
    public static final int ChannellerSlabLoopDungeonTakeScoreRewardReq = 8052;
    public static final int ChannellerSlabLoopDungeonTakeScoreRewardRsp = 8933;
    public static final int ChannellerSlabLoopDungeonChallengeInfoNotify = 8684;
    public static final int ChannellerSlabLoopDungeonSelectConditionReq = 8993;
    public static final int ChannellerSlabLoopDungeonSelectConditionRsp = 8283;
    public static final int ChannellerSlabOneOffDungeonInfoReq = 8775;
    public static final int ChannellerSlabOneOffDungeonInfoRsp = 8872;
    public static final int ChannellerSlabOneOffDungeonInfoNotify = 8339;
    public static final int ChannellerSlabSaveAssistInfoReq = 8151;
    public static final int ChannellerSlabSaveAssistInfoRsp = 8537;
    ...
    public static final int ChannellerSlabCheckEnterLoopDungeonReq = 8461;
    public static final int ChannellerSlabCheckEnterLoopDungeonRsp = 8122;
    ...
    public static final int HideAndSeekChooseMapReq = 8583;
    public static final int HideAndSeekChooseMapRsp = 8636;
    ...
    public static final int LJPLMCEJECG = 22028;
    public static final int FCAIALHCIKL = 21252;
    ...
    public static final int VintageMarketDeliverItemReq = 21795;
    public static final int VintageMarketDeliverItemRsp = 22707;
    public static final int SceneGalleryVintageHuntingSettleNotify = 24566;
    public static final int VintagePresentFinishNoify = 23825;
    public static final int VintageDecorateBoothReq = 20581;
    public static final int VintageDecorateBoothRsp = 23197;
    public static final int VintageHuntingStartGalleryReq = 20722;
    public static final int VintageHuntingStartGalleryRsp = 24058;
    public static final int VintageCampGroupBundleRegisterNotify = 24980;
    public static final int VintageCampStageFinishNotify = 24731;
    public static final int VintageMarketStartStorePlayReq = 22355;
    public static final int VintageMarketStartStorePlayRsp = 21832;
    public static final int VintageMarketFinishStorePlayReq = 21144;
    public static final int VintageMarketFinishStorePlayRsp = 24767;
    public static final int VintagePresentFinishNotify = 20166;
    public static final int VintageMarketStoreUnlockSlotReq = 20862;
    public static final int VintageMarketStoreUnlockSlotRsp = 22742;
    public static final int VintageMarketStoreChooseStrategyReq = 23012;
    public static final int VintageMarketStoreChooseStrategyRsp = 21265;
    public static final int VintageMarketStoreViewStrategyReq = 20229;
    public static final int VintageMarketStoreViewStrategyRsp = 24388;
    public static final int VintageMarketDividendFinishNotify = 24165;
    public static final int VintageMarketNpcEventFinishNotify = 24538;
    public static final int WindFieldRestartDungeonReq = 24841;
    public static final int WindFieldRestartDungeonRsp = 20488;
    public static final int EnterFungusFighterPlotDungeonReq = 24171;
    public static final int EnterFungusFighterPlotDungeonRsp = 24284;
    public static final int FungusFighterPlotInfoNotify = 24684;
    public static final int FungusCultivateReq = 22893;
    public static final int FungusCultivateRsp = 24534;
    public static final int FungusRenameReq = 23177;
    public static final int FungusRenameRsp = 20353;
    public static final int EnterFungusFighterTrainingDungeonReq = 23230;
    public static final int EnterFungusFighterTrainingDungeonRsp = 24555;
    public static final int FungusFighterRuntimeDataNotify = 22163;
    public static final int FungusFighterTrainingSelectFungusReq = 21230;
    public static final int FungusFighterTrainingSelectFungusRsp = 22475;
    public static final int FungusFighterTrainingGallerySettleNotify = 23001;
    public static final int FungusFighterClearTrainingRuntimeDataReq = 20487;
    public static final int FungusFighterClearTrainingRuntimeDataRsp = 20704;
    public static final int FungusFighterUseBackupFungusReq = 22447;
    public static final int FungusFighterUseBackupFungusRsp = 20224;
    public static final int FungusFighterRestartTraningDungeonReq = 23269;
    public static final int FungusFighterRestartTraningDungeonRsp = 21201;
    public static final int CharAmusementSettleNotify = 23878;
    public static final int EffigyChallengeV2EnterDungeonReq = 21076;
    public static final int EffigyChallengeV2EnterDungeonRsp = 23071;
    public static final int EffigyChallengeV2RestartDungeonReq = 21526;
    public static final int EffigyChallengeV2RestartDungeonRsp = 22894;
    public static final int EffigyChallengeV2ChooseSkillReq = 20761;
    public static final int EffigyChallengeV2ChooseSkillRsp = 20946;
    public static final int EffigyChallengeV2DungeonInfoNotify = 24928;
    public static final int CoinCollectChooseSkillReq = 23760;
    public static final int CoinCollectChooseSkillRsp = 23686;
    public static final int RestartCoinCollectPlaySingleModeReq = 22436;
    public static final int RestartCoinCollectPlaySingleModeRsp = 22442;
    public static final int EndCoinCollectPlaySingleModeReq = 20710;
    public static final int EndCoinCollectPlaySingleModeRsp = 23912;
    public static final int CoinCollectPrepareReq = 23543;
    public static final int CoinCollectPrepareRsp = 20576;
    public static final int CoinCollectInterruptPlayReq = 20183;
    public static final int CoinCollectInterruptPlayRsp = 20789;
    public static final int CoinCollectCheckDoubleStartPlayReq = 24962;
    public static final int CoinCollectCheckDoubleStartPlayRsp = 24937;
    public static final int SingleStartBrickBreakerReq = 21647;
    public static final int SingleStartBrickBreakerRsp = 21829;
    public static final int SingleRestartBrickBreakerReq = 23884;
    public static final int SingleRestartBrickBreakerRsp = 24780;
    public static final int BrickBreakerSettleNotify = 24530;
    public static final int BrickBreakerTwiceStartReq = 21977;
    public static final int BrickBreakerTwiceStartRsp = 21089;
    public static final int BrickBreakerQuitReq = 20602;
    public static final int BrickBreakerQuitRsp = 24182;
    public static final int LanV3BoatGameStartSingleReq = 24992;
    public static final int LanV3BoatGameStartSingleRsp = 24118;
    public static final int LanV3BoatGameTransferFinishNotify = 20841;
    public static final int LanV3RaceSettleNotify = 20675;
    public static final int LanV3RaceRestartReq = 23047;
    public static final int LanV3RaceRestartRsp = 20283;
    public static final int LanV3BoatInterruptSettleStageReq = 24158;
    public static final int LanV3BoatInterruptSettleStageRsp = 21299;
    public static final int LanV3ShadowFinishLevelReq = 23886;
    public static final int LanV3ShadowFinishLevelRsp = 24969;
    public static final int DuelHeartEnterDungeonReq = 20812;
    public static final int DuelHeartEnterDungeonRsp = 23202;
    public static final int DuelHeartRestartDungeonReq = 20618;
    public static final int DuelHeartRestartDungeonRsp = 23127;
    public static final int DuelHeartSelectDifficultyReq = 24776;
    public static final int DuelHeartSelectDifficultyRsp = 22574;
    public static final int DuelHeartSettleNotify = 24252;
    public static final int DuelHeartCgEndNotify = 21698;
    public static final int MPBPNIEHNJH = 20385;
    public static final int TeamChainEnterDungeonReq = 22209;
    public static final int TeamChainEnterDungeonRsp = 20950;
    public static final int TeamChainRestartDungeonReq = 24527;
    public static final int TeamChainRestartDungeonRsp = 21962;
    public static final int TeamChainDungeonInfoNotify = 24485;
    public static final int TeamChainTakeCostumeRewardReq = 22079;
    public static final int TeamChainTakeCostumeRewardRsp = 22075;
    public static final int HNHDBOANHDF = 21624;
    public static final int ACEPHCGAPCJ = 21598;
    ...
    public static final int ElectroherculesBattleSelectDifficultyReq = 24308;
    public static final int ElectroherculesBattleSelectDifficultyRsp = 21035;
    public static final int ElectroherculesBattleSettleNotify = 22145;
    public static final int MDBHGIIOPKI = 20143;
    public static final int OFJKMJFMLCO = 20508;
    public static final int PGHDNINMDJM = 24347;
    public static final int GIIHGMKANHL = 22187;
    public static final int BMBJFJNIAKL = 22180;
    public static final int OKNMFKCKJGP = 20858;
    public static final int JMBNLGPPMDP = 24764;
    public static final int EJLEHCFOMPK = 21504;
    public static final int OHAGCADDFGA = 21758;
    public static final int BFICMJMHKJL = 23293;
    public static final int FLNMFCNPKEH = 23172;
    public static final int CEMGDGAHDPJ = 24935;
    public static final int HCCDEDBNNLH = 21126;
    public static final int PIIMBAGDDNJ = 22162;
    public static final int KHJBEOHBNBG = 23597;
    public static final int AMFIEDJGLPA = 23014;
    public static final int KKEAGOHBCMA = 22846;
    public static final int HNMGHDHJJMF = 21621;
    public static final int EMMNAJMFCBC = 24818;
    public static final int CJEDPJPHDFD = 21417;
    public static final int MMBGBMHBIBA = 23464;
    public static final int MMPGFBFANOB = 22907;
    public static final int MGEHIFOHGIA = 24781;
    public static final int BCMJEDNDIGM = 21475;
    public static final int HNBJBLPCGIK = 24470;
    public static final int OLCOENGMPPC = 24985;
    public static final int DIOKGLJIAMG = 23859;
    public static final int CELPBGOAJJB = 22763;
    public static final int JDPJGAHPGFH = 20071;
    public static final int AKIFJCCDNEM = 22017;
    public static final int NOEABFFFIBJ = 23303;
    public static final int FAPDLKNEPCH = 20550;
    public static final int CNEDGHOJKNH = 20910;
    public static final int LIDDFAKFGLG = 20158;
    public static final int IBEBIDMINKK = 21605;
    public static final int FFEBPGAHDIE = 21778;
    public static final int ENKAIAJHBOL = 23718;
    public static final int JLFLCCDNNIL = 22940;
    public static final int ANLPPAMFPKC = 24529;
    public static final int JFDELDDOOIJ = 20509;
    public static final int PEEKHLNIGJH = 21486;
    public static final int AJFDAKKHGKO = 24951;
    public static final int LGLHGBPEOGD = 20971;
    public static final int PIGIPONAOCL = 23193;
    public static final int MFEOLMIMPCE = 22376;
    public static final int DDHHEKPMCJA = 24406;
    public static final int LIDABDAPMJK = 22570;
    public static final int ODCPBFFABNO = 21648;
    public static final int CMGBHAALJIJ = 22877;
    public static final int DECAIBABCPP = 23245;
    public static final int DCJEGFPGKEF = 24889;
    public static final int NNOJLDPDPIE = 21876;
    public static final int LBFHEDFPGMI = 22710;
    public static final int GELGLOAKDBI = 21051;
    public static final int PMBAFLIIPEC = 20539;
    public static final int IFMDOEMIPDM = 21525;
    public static final int HPJKJMBIFPH = 24533;
    public static final int HMOBMGADFAJ = 23343;
    public static final int DNKBHCGAALL = 21932;
    public static final int DOFGFCEODEN = 21801;
    public static final int IFOKONFKCDP = 24495;
    public static final int AranaraCollectionDataNotify = 6359;
    public static final int AddAranaraCollectionNotify = 6366;
    public static final int CataLogFinishedGlobalWatcherAllDataNotify = 6392;
    public static final int CataLogNewFinishedGlobalWatcherNotify = 6386;
    ...
    public static final int AvatarRenameInfoNotify = 1783;
    public static final int ItemRenameAvatarReq = 1617;
    public static final int ItemRenameAvatarRsp = 1656;
    public static final int IIBEEMFEJHJ = 1714;
    public static final int CGPNDMOBAOI = 1686;
    ...
    public static final int ChatChannelShieldNotify = 5015;
    public static final int ChatChannelInfoNotify = 5049;
    ...
    public static final int MistTrialFloorLevelNotify = 919;
    public static final int DungeonReviseLevelNotify = 927;
    public static final int AOEICADFFIJ = 968;
    public static final int HOJHJGGEABM = 993;
    ...
    public static final int LEKKBIGCOGI = 1592;
    ...
    public static final int LDMCFCEHKJH = 829;
    ...
    public static final int WindFieldGalleryInfoNotify = 5598;
    public static final int WindFieldGalleryChallengeInfoNotify = 5597;
    public static final int FungusFighterTrainingInfoNotify = 5581;
    public static final int FungusCaptureSettleNotify = 5570;
    public static final int HideAndSeekPlayerCapturedNotify = 5535;
    public static final int CoinCollectGallerySettleNotify = 5533;
    public static final int NLMGCGCNKHG = 5583;
    public static final int BCAOAGGPONH = 5506;
    public static final int HDHPLGOCHCP = 5504;
    public static final int ONMECJLKJJC = 5554;
    public static final int MDHPLAGPINN = 5543;
    public static final int EKIOINEMBPA = 5529;
    public static final int FBJAPCKJFCA = 5528;
    public static final int NOOGKCGHOPN = 5574;
    public static final int GCGOperationReq = 7479;
    public static final int GCGOperationRsp = 7925;
    public static final int GCGMessagePackNotify = 7133;
    public static final int GCGAskDuelReq = 7631;
    public static final int GCGAskDuelRsp = 7088;
    public static final int GCGGameBriefDataNotify = 7068;
    public static final int GCGInitFinishReq = 7052;
    public static final int GCGInitFinishRsp = 7933;
    public static final int GCGHeartBeatNotify = 7684;
    public static final int GCGSkillPreviewNotify = 7993;
    public static final int GCGSkillPreviewAskReq = 7283;
    public static final int GCGSkillPreviewAskRsp = 7775;
    public static final int GCGChallengeUpdateNotify = 7872;
    public static final int GCGBackToDuelReq = 7339;
    public static final int GCGBackToDuelRsp = 7151;
    public static final int GCGDebugReplayNotify = 7537;
    public static final int GCGGameMaxNotify = 7943;
    public static final int GCGGameCreateFailReasonNotify = 7364;
    public static final int JEHMOJKEODL = 7804;
    public static final int CMELIOKBBAM = 7558;
    public static final int CJPDFDFACHM = 7243;
    public static final int GCGDSDataNotify = 7975;
    public static final int GCGDSCardBackUnlockNotify = 7526;
    public static final int GCGDSFieldUnlockNotify = 7820;
    public static final int GCGDSCardFaceUnlockNotify = 7035;
    public static final int GCGDSCardNumChangeNotify = 7865;
    public static final int GCGDSChangeCardFaceReq = 7498;
    public static final int GCGDSChangeCardFaceRsp = 7050;
    public static final int GCGDSChangeCardBackReq = 7879;
    public static final int GCGDSChangeCardBackRsp = 7367;
    public static final int GCGDSChangeFieldReq = 7303;
    public static final int GCGDSChangeFieldRsp = 7735;
    public static final int GCGDSChangeDeckNameReq = 7007;
    public static final int GCGDSChangeDeckNameRsp = 7117;
    public static final int GCGDSDeckSaveReq = 7118;
    public static final int GCGDSDeckSaveRsp = 7065;
    public static final int GCGDSChangeCurDeckReq = 7752;
    public static final int GCGDSChangeCurDeckRsp = 7037;
    public static final int GCGDSCurDeckChangeNotify = 7449;
    public static final int GCGDSDeleteDeckReq = 7398;
    public static final int GCGDSDeleteDeckRsp = 7176;
    public static final int GCGDSDeckUnlockNotify = 7511;
    public static final int GCGDSCardProficiencyNotify = 7263;
    public static final int GCGDSDeckUpdateNotify = 7159;
    public static final int GCGDSCardFaceUpdateNotify = 7599;
    public static final int GCGDSTakeCardProficiencyRewardReq = 7814;
    public static final int GCGDSTakeCardProficiencyRewardRsp = 7930;
    public static final int GCGDSBanCardNotify = 7793;
    public static final int GCGTCTavernInfoNotify = 7507;
    public static final int GCGTCInviteReq = 7926;
    public static final int GCGTCInviteRsp = 7994;
    public static final int GCGTCTavernChallengeDataNotify = 7414;
    public static final int GCGTCTavernChallengeUpdateNotify = 7281;
    public static final int GCGGrowthLevelNotify = 7198;
    public static final int GCGGrowthLevelRewardNotify = 7470;
    public static final int GCGGrowthLevelTakeRewardReq = 7787;
    public static final int GCGGrowthLevelTakeRewardRsp = 7332;
    public static final int GCGInviteGuestBattleReq = 7407;
    public static final int GCGInviteGuestBattleRsp = 7464;
    public static final int GCGInviteBattleNotify = 7450;
    public static final int GCGApplyInviteBattleReq = 7374;
    public static final int GCGApplyInviteBattleRsp = 7107;
    public static final int GCGApplyInviteBattleNotify = 7179;
    public static final int GCGWorldPlayerGCGStateReq = 7605;
    public static final int GCGWorldPlayerGCGStateRsp = 7880;
    public static final int GCGSettleNotify = 7504;
    public static final int GCGResourceStateNotify = 7670;
    public static final int GCGClientSettleReq = 7369;
    public static final int GCGClientSettleRsp = 7510;
    public static final int GCGSettleOptionReq = 7706;
    public static final int GCGSettleOptionRsp = 7356;
    public static final int GCGBasicDataNotify = 7722;
    public static final int GCGTavernNpcInfoNotify = 7111;
    public static final int GCGStartChallengeReq = 7547;
    public static final int GCGStartChallengeRsp = 7763;
    public static final int GCGWeekChallengeInfoNotify = 7747;
    public static final int GCGStartChallengeByCheckRewardReq = 7949;
    public static final int GCGStartChallengeByCheckRewardRsp = 7020;
    public static final int GCGLevelChallengeNotify = 7023;
    public static final int GCGLevelChallengeFinishNotify = 7969;
    public static final int GCGWorldChallengeUnlockNotify = 7766;
    public static final int GCGBossChallengeUpdateNotify = 7570;
    public static final int GCGLevelChallengeDeleteNotify = 7377;
    public static final int DOBDAICHFII = 7520;
    public static final int LGDLKBJBEOE = 7310;
    public static final int GEBNMMPJMPG = 7920;
    public static final int AFPBCMBHGNC = 7031;
    public static final int MHIGNIDFIJO = 7500;
    public static final int MILOEMBOIBJ = 7988;
    public static final int INJOAAKAIKI = 7274;
    public static final int NMPEGOIHHIH = 7486;
    public static final int CAPOJBJBBPA = 7308;
    public static final int ICCLMODGOGJ = 7669;
    public static final int IKJBDPHEAAD = 7433;
    ...
    public static final int NLPPFFGOIED = 5765;
    ...
    public static final int HomeUpdateScenePointFishFarmingInfoReq = 4777;
    public static final int HomeUpdateScenePointFishFarmingInfoRsp = 4800;
    public static final int HomeScenePointFishFarmingInfoNotify = 4851;
    ...
    public static final int HomeGetBlueprintSlotInfoReq = 4790;
    public static final int HomeGetBlueprintSlotInfoRsp = 4781;
    public static final int HomeSetBlueprintSlotOptionReq = 4785;
    public static final int HomeSetBlueprintSlotOptionRsp = 4469;
    public static final int HomeSetBlueprintFriendOptionReq = 4547;
    public static final int HomeSetBlueprintFriendOptionRsp = 4849;
    public static final int HomeBlueprintInfoNotify = 4609;
    public static final int HomePreviewBlueprintReq = 4841;
    public static final int HomePreviewBlueprintRsp = 4590;
    public static final int HomeCreateBlueprintReq = 4806;
    public static final int HomeCreateBlueprintRsp = 4553;
    public static final int HomeDeleteBlueprintReq = 4737;
    public static final int HomeDeleteBlueprintRsp = 4894;
    public static final int HomeSearchBlueprintReq = 4720;
    public static final int HomeSearchBlueprintRsp = 4697;
    public static final int AKEHHECCPOO = 4809;
    public static final int FKKDNFEPMIL = 4614;
    public static final int LDAKAIIPNGI = 4833;
    public static final int EGBCJEGNFBG = 4870;
    public static final int APAEMKIJPBM = 4489;
    public static final int ADMHOKGPIHC = 4517;
    public static final int HomeSaveArrangementNoChangeReq = 4715;
    public static final int HomeSaveArrangementNoChangeRsp = 4887;
    ...
    public static final int ReliquaryFilterStateSaveNotify = 653;
    public static final int ReliquaryFilterStateNotify = 605;
    ...
    public static final int GetAllMailRsp = 1478;
    ...
    public static final int PlayerGCGMatchDismissNotify = 4193;
    public static final int PlayerGCGMatchConfirmNotify = 4187;
    public static final int PHFEMFDEIPP = 4198;
    ...
    public static final int InBattleMechanicusExcapeMonsterNotify = 5316;
    ...
    public static final int BrickBreakerPlayerReadyNotify = 5317;
    public static final int BrickBreakerPlayerSetAvatarNotify = 5320;
    public static final int BrickBreakerPlayerSetSkillNotify = 5385;
    public static final int BrickBreakerSetReadyReq = 5331;
    public static final int BrickBreakerSetReadyRsp = 5325;
    public static final int BrickBreakerSelectAvatarReq = 5367;
    public static final int BrickBreakerSelectAvatarRsp = 5379;
    public static final int BrickBreakerSelectSkillReq = 5313;
    public static final int BrickBreakerSelectSkillRsp = 5387;
    public static final int BrickBreakerSetChangingReq = 5362;
    public static final int BrickBreakerSetChangingRsp = 5323;
    public static final int BrickBreakerPlayerSetChangingNotify = 5330;
    public static final int CoinCollectPrepareStageNotify = 6569;
    public static final int LanV3BoatSettleNotify = 6598;
    public static final int BFFEMLKIMGD = 6497;
    public static final int BACLCEEBIAD = 6461;
    ...
    public static final int FinishedTalkIdListNotify = 592;
    ...
    public static final int BCBNCBGIEJO = 2910;
    public static final int GFGKHDBBKIL = 2916;
    public static final int CFPNMMHIFLK = 2921;
    public static final int AMPEPAJDMFH = 2909;
    public static final int LPKHFHJDGOG = 2924;
    public static final int GNENODIAGCE = 2911;
    ...
    public static final int KLNMFNNADPG = 2324;
    public static final int JPKNOEMJICG = 2301;
    ...
    public static final int ExclusiveRuleNotify = 109;
    ...
    public static final int QuestRenameAvatarReq = 424;
    ...
    public static final int AICCFCMGNBG = 5069;
    public static final int FLECEKOBOLN = 5094;
    ...
    public static final int BeginCameraSceneLookWithTemplateNotify = 3314;
    public static final int RefreshEntityAuthNotify = 3416;
    public static final int ScenePlayerBackgroundAvatarRefreshNotify = 3466;
    public static final int BBAEFJPLEPN = 3408;
    ...
    public static final int BatchBuyGoodsReq = 792;
    public static final int BatchBuyGoodsRsp = 763;
    ...
    public static final int ToTheMoonObstaclesModifyNotify = 6163;
    public static final int DIJAILOHJEA = 6159;
    ...
    public static final int HIDEKBNDDIP = 6324;
    public static final int AAEIMMOLJAF = 6325;
    public static final int AJFBMFBKOIG = 6343;
    ...
    public static final int OneoffGatherPointDetectorDataNotify = 4274;
    ...
    public static final int WidgetWeatherWizardDataNotify = 6035;
    public static final int NJIKLIJCLDA = 6089;
}